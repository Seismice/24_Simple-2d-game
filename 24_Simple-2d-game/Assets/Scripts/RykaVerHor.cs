...
{
    private Vector3 verticalPosition = new Vector3(0f, 0.08f, 0f);
    private Vector3 horizontalPosition = new Vector3(0.4f, 0.29f, 0f);
    private Vector3 horizontalPositionLeft = new Vector3(-0.45f, 0.29f, 0f);
