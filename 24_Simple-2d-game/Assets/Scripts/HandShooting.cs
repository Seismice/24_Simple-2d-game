...
public class HandShooting : MonoBehaviour
{
    ...
    void Shoot()
    {
        if (_playerController.isRiht == true && _rykaVerHor.isHorizontalPositionLeft == false)
        {
        ...
        if (_playerController.isRiht == false && _rykaVerHor.isHorizontalPositionLeft == true)
        {
